 ...
 * @author Peter Abeles
 */
public class TrackerObjectQuadPanel_Modified extends ImagePanel implements MouseListener, MouseMotionListener {
	...
	public TrackerObjectQuadPanel_Modified(Listener listener) {
